...
public class LineColorPane extends CustomColorPane {
	
	private static final Color DEFAULT_COLOR = Color.BLACK;
	private static final int BOX_ROW = 2;
	private static final int LABEL_ROW = 0;
	private static final String BACK_STRING = "Select a Line Color";
	
	private ColorPicker myColorPicker = new ColorPicker();
	
	public LineColorPane(GridPane grid, double width, double height, int x_location){

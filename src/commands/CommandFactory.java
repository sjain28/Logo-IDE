...
public class CommandFactory {
	...
	public Command makeCommand(String name) throws Exception {
		...
		for(String key: myResourceBundle.keySet()){
			if(myResourceBundle.getString(key).contains(commandName) || myResourceBundle.getString(key).contains("|"+commandName) || myResourceBundle.getString(key).contains(commandName+"|")){ //Do this with RegEx...This is messy
				command += key;
